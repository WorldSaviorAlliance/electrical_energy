...
%>
<h4 class="page-title detail_sub_title">当前位置：<span >电源商管理</span> / <span >购电合约</span></h4>
		...
		<div class="tab-content detail_content">
			<div class="row" style="margin: 15px 0px;">
				...
				<div class="col-md-4 control-group ">
					...
					<div class="controls">
						<div class="input-group" style="padding: 0px;">
							...
							<input class="form-control" type="text" name="date-range-picker" id="bcRangTime" />
						</div>
					</div>				
				</div>
				<div class="col-md-3">
				...
				<div class="control-group col-md-2">
					<button class="btn btn-primary" id="searchBc">查询</button>
					<button class="btn btn-info" id="addBc">添加</button>
				</div>
			</div>
			<table class="table table-striped table-hover" style="margin-bottom:10px;border: 1px solid #ddd;background-color: #FFFFFF;">
				...
				<tbody id="bc_table">
					<tr>
						...
						<td>
							<a class="btn btn-primary btn-xs" style="margin-right: 20px;" flag="modify_bc">修改</a>
							<a class="btn btn-danger btn-xs" flag="del_bc">删除</a>
						</td>
					</tr>
					<tr>
						<td>测试电源商1</td>
...
<script type="text/javascript" src="<%=basePath%>static/js/contract/bc.js"></script>
