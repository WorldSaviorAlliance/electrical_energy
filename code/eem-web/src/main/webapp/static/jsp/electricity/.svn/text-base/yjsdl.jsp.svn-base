		...
		<div class="tab-content detail_content">
			<div class="row" style="margin: 15px 0px;">
				...
				<div class="col-md-4 control-group ">
					...
					<div class="controls">
						<div class="input-group" style="padding: 0px;">
							...
							<input class="form-control" type="text" name="date-range-picker" id="bmRangTime" />
						</div>
					</div>				
				</div>
				<div class="col-md-3">
				...
				<div class="control-group col-md-2">
					<button class="btn btn-primary" id="searchBm">查询</button>
					<button class="btn btn-info" id="addBm">添加</button>
				</div>
			</div>
			<table class="table table-striped table-hover" style="margin-bottom:10px;border: 1px solid #ddd;background-color: #FFFFFF;">
				...
				<tbody id="bm_table">
					<tr>
						...
						<td>
							<a class="btn btn-primary btn-xs" style="margin-right: 20px;" flag="modify_bm">修改</a>
							<a class="btn btn-danger btn-xs" flag="del_bm">删除</a>
						</td>
					</tr>
					<tr>
						<td>测试电源商1</td>
