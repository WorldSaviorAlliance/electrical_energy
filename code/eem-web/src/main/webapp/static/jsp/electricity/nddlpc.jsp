...
%>
<h4 class="page-title detail_sub_title">当前位置：<span>电量管理</span> / <span >年度电量偏差</span></h4>
			...
			<div class="col-md-4">
				<div class="form-group">
					<label class="col-sm-2 control-label">年份</label>
	                  <div class="col-sm-4">
		                   <select class="select" data-placeholder="请选择开始年份" id="year">
...
<script type="text/javascript" src="<%=basePath%>static/js/electricity/nddlpc.js"></script>
